...
urlpatterns += [
    ...
    # Social views
    re_path(r"^account-geonode/signup/", CustomSignupView.as_view(), name="account_signup"),
    re_path(r"^account-geonode/login/", CustomLoginView.as_view(), name="account_login"),
    re_path(r"^account-geonode/", include("allauth.urls")),
    ...
    # Accounts
    re_path(r"^account-geonode/ajax_login$", geonode.views.ajax_login, name="account_ajax_login"),
    re_path(r"^account-geonode/ajax_lookup$", geonode.views.ajax_lookup, name="account_ajax_lookup"),
    re_path(
        r"^account-geonode/moderation_sent/(?P<inactive_user>[^/]*)$",
        geonode.views.moderator_contacted,
        name="moderator_contacted",
    ),
    re_path(
        r"^account-geonode/moderation_needed/",
